...
IUSE="${IUSE_SERVERS} debug display_init eglstream +elogind ipv6 minimal selinux suid systemd test +udev unwind xcsecurity"
RESTRICT="!test? ( test )"
...
"
RDEPEND="${CDEPEND}
	!systemd? ( display_init? ( gui-libs/display-manager-init ) )
...
src_configure() {
	...
	local XORG_CONFIGURE_OPTIONS=(
		...
		$(use_enable eglstream xwayland_eglstream)
