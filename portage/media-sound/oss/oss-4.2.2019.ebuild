...
OSS_DEPRECATED_CARDS="allegro als3xx als4k digi32 maestro neomagic s3vibes vortex"

OSS_CARDS="ali5455 atiaudio audigyls audiocs audioloop audiopci cmi878x cmpci cs4281 cs461x
...
#	epatch "${FILESDIR}/linux-4.11.patch"
	...
	for deprecated_card in ${OSS_DEPRECATED_CARDS} ; do
