...
SLOT="0/0.4"
IUSE="bell bluetooth doc echo-cancel extra gstreamer jack-client jack-sdk lv2 pipewire-alsa ssl system-service systemd test v4l X zeroconf"
...
multilib_src_configure() {
	...
	local emesonargs=(
		...
		$(meson_native_use_feature bell libcanberra)
	)
