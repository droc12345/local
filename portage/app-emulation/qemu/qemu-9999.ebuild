...
#PATCHES=(
#	"${FILESDIR}"/qemu-5.2.0-disable-keymap.patch
#	"${FILESDIR}"/qemu-6.0.0-make.patch
#	"${FILESDIR}"/qemu-7.1.0-also-build-virtfs-proxy-helper.patch
#	"${FILESDIR}"/qemu-7.1.0-capstone-include-path.patch
#	"${FILESDIR}"/qemu-7.1.0-strings.patch
#)
